...
class _TaskDetailsScreenState extends State<TaskDetailsScreen> {
  ...
  void getTaskData() async {
    ...
    final DocumentSnapshot workerDoc = await FirebaseFirestore.instance
        .collection('users')
        .doc(widget.assignedID)
        .get();
    if (workerDoc == null) {
      return;
    } else {
      setState(() {
        workerrName = workerDoc.get('name');
        workerPosition = workerDoc.get('positionInCompany');
        workerImageUrl = workerDoc.get('userImage');
      });
    }
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image: NetworkImage(workerImageUrl == null
